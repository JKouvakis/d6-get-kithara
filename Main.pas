...
begin
  ...
  begin
    PrintPreview.PrintJobTitle := PrintPreview.PrintJobTitle + Form3.Label5.Caption;
...
begin
    ...
    try
      Form3.Song.Lines.savetostream  ( mem );
      mem.seek ( 0, soFromBeginning ); // set position = 0
      RichEdit.Lines.loadfromstream ( mem );
    finally
      mem.free;
    end;
    ...
    RichEdit.Lines.Insert(0,Form3.Label5.Caption);
    RichEdit.SelAttributes.Color := clBlack;
    RichEdit.SelAttributes.Size := 10;
    RichEdit.SelAttributes.Style := [fsbold,fsitalic];
    RichEdit.Lines.Insert(1,Form3.Label6.Caption);
    RichEdit.SelAttributes.Color := clBlack;
    RichEdit.SelAttributes.Size := 10;
    RichEdit.SelAttributes.Style := [fsbold,fsitalic];
    RichEdit.Lines.Insert(2,Form3.Label7.Caption);
    RichEdit.Lines.Insert(3,' ');
    RenderRichEdit;
end;
...
begin
  case PrintPreview.ZoomState of
    ...
    case PrintPreview.Zoom of
      150: ZoomComboBox.ItemIndex := 3;
      100: ZoomComboBox.ItemIndex := 2;
      75: ZoomComboBox.ItemIndex := 1;
...
begin
  ...
  begin
    ...
    SetRect(TextRect[False], 2000, 2000, PaperWidth , PaperHeight );
...
//  PrintPreview.ZoomState := zsZoomToFit;
  ZoomComboBox.ItemIndex := 1; // Zoom to Fit (Whole Page)
  OpenButtonClick(MainForm);
  Form3.Hide;
end;
